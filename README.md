...
Placar válido: games de 0 a 7, pelo menos um dos lados com 4 games ou mais, e
**empates não são permitidos** (ex.: 4 × 4 é inválido).
...
- **Duplas fixas** — todos contra todos simples entre as 4 duplas: cada confronto
  acontece **uma única vez**, em 3 rodadas com 2 partidas cada.
